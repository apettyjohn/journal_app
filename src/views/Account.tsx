...
import {Tune, Edit, Person, ExitToApp, ArrowBack} from "@material-ui/icons";
...
function Account() {
    ...
    function showLabels(){
        ...
        for (let i=0;i<buttons.length;i++){
            buttons[i].appendChild(document.createTextNode(labels[i]));
        }
    }
    function hideLabels(){
        const buttons = document.getElementById("account-side-menu")!.getElementsByClassName("MuiButton-label");
        ...
        <div className="view" style={{display: 'flex', flexDirection: 'row'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', flexGrow: '1'}}>
                <Card style={{overflow: 'visible'}}>
                    <CardContent style={{display: "flex", flexDirection: "row", justifyContent: "space-between", marginRight: '2em', marginLeft: '2em'}}>
                        <div style={{display: "flex", justifyContent: "space-evenly", flexDirection: "column", marginRight: '3em'}}>
                            <ProfilePic size={"large"} user={user}/>
                            <Button className="systemText" style={{marginTop: '1em', marginBottom: '1em'}}>Edit</Button>
                            <Button className="systemText">Delete</Button>
                        </div>
                        <div style={{display: "flex", justifyContent: "space-evenly", flexGrow: '1', flexDirection: "column"}}>
                            <div style={{display: "flex", flexDirection: "row", alignItems: "center"}}>
                                <Typography style={{whiteSpace: 'nowrap'}}>Name :</Typography>
                                <Typography style={{marginLeft:'2em', marginRight:'2em'}}>{user.name}</Typography>
                                <IconButton aria-label="edit">
                                    <Edit />
                                </IconButton>
                            </div>
                            <div style={{display: "flex", flexDirection: "row", alignItems: "center", paddingTop: '1em', paddingBottom: '1em'}}>
                ...
                <Card style={{overflow: 'visible'}}>
                    <CardContent style={{marginRight: '2em', marginLeft: '2em'}}>
                        <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                            <Typography className="systemText" style={{whiteSpace: 'nowrap'}}>System Theme :</Typography>
                        ...
                        <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", paddingRight: '3em'}}>
